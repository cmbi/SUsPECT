...
vep --cache --merged --assembly GRCh38 --cache_version 104 --max_af --sift b --polyphen b --protein --domains --plugin Conservation,/home/renees/.vep/gerp_conservation_scores.homo_sapiens.GRCh38.bw --gff LR_transdecoder.gff.gz --pick_allele --pick_order rank,biotype,length --fasta $genomefile --no_stats --offline --fork 4 --force -i $variantfile -o LR_all_patients.tab
